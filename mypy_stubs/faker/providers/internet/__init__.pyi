...
from faker.utils.decorators import lowercase as lowercase, slugify as slugify, slugify_unicode as slugify_unicode
...
class Provider(BaseProvider):
    ...
    def ipv4(self, network: bool = ..., address_class: Optional[Any] = ..., private: Optional[Any] = ...): ...
