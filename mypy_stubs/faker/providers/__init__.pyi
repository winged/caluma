from faker.utils.distribution import choices_distribution as choices_distribution, choices_distribution_unique as choices_distribution_unique
...
class BaseProvider:
    ...
    def random_elements(self, elements: Any = ..., length: Optional[Any] = ..., unique: bool = ...): ...
    ...
    def randomize_nb_elements(self, number: int = ..., le: bool = ..., ge: bool = ..., min: Optional[Any] = ..., max: Optional[Any] = ...): ...
