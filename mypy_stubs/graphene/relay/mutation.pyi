...
class ClientIDMutation(Mutation):
    class Meta:
        abstract: bool = ...
    @classmethod
    def __init_subclass_with_meta__(cls, output: Optional[Any] = ..., input_fields: Optional[Any] = ..., arguments: Optional[Any] = ..., name: Optional[Any] = ..., **options: Any) -> None: ...
    @classmethod
    def mutate(cls, root: Any, info: Any, input: Any): ...
