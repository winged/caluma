...
class Mutation(ObjectType):
    @classmethod
    def __init_subclass_with_meta__(cls, interfaces: Any = ..., resolver: Optional[Any] = ..., output: Optional[Any] = ..., arguments: Optional[Any] = ..., _meta: Optional[Any] = ..., **options: Any) -> None: ...
    @classmethod
    def Field(cls, name: Optional[Any] = ..., description: Optional[Any] = ..., deprecation_reason: Optional[Any] = ..., required: bool = ...): ...
