...
def object_filter(request: Any, model: Optional[Any] = ..., queryset: Optional[Any] = ..., template_name: Optional[Any] = ..., extra_context: Optional[Any] = ..., context_processors: Optional[Any] = ..., filter_class: Optional[Any] = ...): ...
