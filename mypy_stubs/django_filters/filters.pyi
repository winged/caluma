...
class Filter:
    ...
    exclude: Any = ...
    extra: Any = ...
    def __init__(self, field_name: Optional[Any] = ..., lookup_expr: str = ..., *, label: Optional[Any] = ..., method: Optional[Any] = ..., distinct: bool = ..., exclude: bool = ..., **kwargs: Any) -> None: ...
...
class LookupChoiceFilter(Filter):
    ...
    empty_label: Any = ...
    lookup_choices: Any = ...
    def __init__(self, field_name: Optional[Any] = ..., lookup_choices: Optional[Any] = ..., field_class: Optional[Any] = ..., **kwargs: Any) -> None: ...
    @classmethod
